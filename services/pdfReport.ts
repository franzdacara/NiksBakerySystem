...
export const generateShiftReport = (store: BakeryStore) => {
    ...
    const dateStr = shiftDate.toLocaleDateString('en-PH', {
    ...
    const timeStart = shift.startTime ? new Date(shift.startTime).toLocaleTimeString('en-PH', { timeZone: 'Asia/Manila', hour: '2-digit', minute: '2-digit', hour12: true }) : 'N/A';
    const timeEnd = shift.endTime ? new Date(shift.endTime).toLocaleTimeString('en-PH', { timeZone: 'Asia/Manila', hour: '2-digit', minute: '2-digit', hour12: true }) : new Date().toLocaleTimeString('en-PH', { timeZone: 'Asia/Manila', hour: '2-digit', minute: '2-digit', hour12: true });
